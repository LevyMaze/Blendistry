    ...
    <div className="p-4 sm:p-8 space-y-8">
      ...
      <section className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="border p-4 rounded-lg text-center">
          <h2 className="font-semibold">Total Feedbacks</h2>
        ...
        <div className="border p-4 rounded-lg text-center">
          <h2 className="font-semibold">Latest Signup</h2>
          <p className="text-sm">
            {users[0] ? new Date(users[0].created_at).toLocaleString() : "—"}
          </p>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="border p-4 rounded-lg">
          <h2 className="font-semibold mb-3">Feedbacks Over Time</h2>
      ...
      <section className="border rounded-lg p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row justify-between mb-4 items-center gap-3">
          <h2 className="text-xl font-bold">User Feedbacks</h2>
